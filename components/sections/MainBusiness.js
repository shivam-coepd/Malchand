                ...
                <div className="row justify-content-center">
                    <div className="col-lg-8">
                        <div className="section-title text-center mb-60">
                            ...
                            <Link href="/services" className="btn-primary-standard mt-30">
                                EXPLORE MORE
                            </Link>
                        </div>
                    </div>
                                ...
                                <div className="business-img-container">
                                    ...
                                    <div className="business-hover-actions">
                                        <div className="business-actions-inner">
                                            <Link href="/hotels" className="business-action-btn slide-from-left">{item.hoverOptions[0]}</Link>
                                            <Link href="/resorts" className="business-action-btn slide-from-right">{item.hoverOptions[1]}</Link>
                                            <Link href="/retreats" className="business-action-btn slide-from-left delay-btn">{item.hoverOptions[2]}</Link>
                                        </div>
                                    </div>
                                </div>
